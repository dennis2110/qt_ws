...
#define RIGHT_MOTOR1_MAX_VALUE_DEG          (RIGHT_MOTOR1_MAX_DEG)

#define RIGHT_MOTOR1_MIN_DEG                (0.0)
#define RIGHT_MOTOR1_MIN_DEG_VALUE          (RIGHT_MOTOR1_MIN_VALUE)
#define RIGHT_MOTOR1_MIN_VALUE_DEG          (RIGHT_MOTOR1_MIN_DEG)

#define RIGHT_MOTOR2_MAX_DEG                (90.0)
#define RIGHT_MOTOR2_MAX_DEG_VALUE          (RIGHT_MOTOR2_MIN_VALUE)
#define RIGHT_MOTOR2_MIN_VALUE_DEG          (RIGHT_MOTOR2_MAX_DEG)

#define RIGHT_MOTOR2_MIN_DEG                (-90.0)
#define RIGHT_MOTOR2_MIN_DEG_VALUE          (RIGHT_MOTOR2_MAX_VALUE)
#define RIGHT_MOTOR2_MAX_VALUE_DEG          (RIGHT_MOTOR2_MIN_DEG)

#define RIGHT_MOTOR1_INIT_VALUE				(RIGHT_MOTOR1_MIN_DEG_VALUE)
#define RIGHT_MOTOR2_INIT_VALUE				(RIGHT_MOTOR2_MIN_DEG_VALUE)
